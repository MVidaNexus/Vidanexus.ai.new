    ...
    <div class="main-container">
        <header class="header">
            <div class="logo-container">
                <img src="{{ asset('assets/brand-logo.png?v=2026_2') }}" alt="Vida Nexus - Next-Generation AI Solutions & Innovation" class="logo-img" id="logoImg" fetchpriority="high" style="height: 65px; width: auto; object-fit: contain;">
            </div>
        </header>
