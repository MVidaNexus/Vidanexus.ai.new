...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; margin-bottom: 3rem;">
    <a href="{{ route('admin.users.index') }}" class="card-admin" style="display: flex; align-items: center; gap: 1.5rem; text-decoration: none; color: inherit; cursor: pointer; transition: transform 0.3s ease, border-color 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='var(--primary-admin)'" onmouseout="this.style.transform='none'; this.style.borderColor='var(--horizon-border)'">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
    @foreach($tools as $tool)
        <a href="{{ route('admin.horizon.show', $tool['slug']) }}" style="text-decoration: none; color: inherit;">
            <div class="card-admin" style="position: relative; overflow: hidden; transition: all 0.3s ease; height: 100%;">
