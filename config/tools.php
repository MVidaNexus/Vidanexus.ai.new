    ...
    */
    ...
    'all_tools' => [
        ...
        [
            ...
            'description' => 'Stop guessing and start winning. This tool scans the internet to find high-value topics and hidden gaps in the market, giving you a massive head start on your competitors by identifying exactly what your audience is looking for right now.',
            'marketing_content' => '<h3>The Intelligence Behind Your Next Big Win</h3><p>In a world of noise, being first is everything. The <b>Keyword Spy Radar</b> isn\'t just a keyword tool; it\'s your personal intelligence agent that never sleeps. It monitors real-time search velocity, social signals, and competitor movements to identify "Opportunity Pockets" before they become mainstream.</p><ul><li><b>Predictive Discovery:</b> Find topics that are about to explode but haven\'t hit the heavy-weights yet.</li><li><b>Topical Authority Mapping:</b> Know exactly which sub-topics you need to cover to be seen as the ultimate expert by Google.</li><li><b>ROI-Focused Insights:</b> Skip the high-volume/low-intent trap and focus on terms that actually convert.</li></ul>',
            'features' => [
                ['icon' => 'fa-bolt', 'title' => 'Early Opportunity Detection', 'desc' => 'Find profitable topics while they are still fresh and easy to rank for.'],
                ['icon' => 'fa-crosshairs', 'title' => 'Competitor Gap Analysis', 'desc' => 'See exactly where your rivals are weak and take over their territory.'],
                ['icon' => 'fa-coins', 'title' => 'Maximum ROI', 'desc' => 'Get deep market insights with minimal effort, ensuring every piece of content you create has an audience.']
            ],
