...
<body class="bg-[#0d0e12] text-white font-sans selection:bg-primary-cyan/30 selection:text-white">
    ...
    <main class="pt-32 pb-20 min-h-screen px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="mt-24 flex justify-center pb-12">
            <a href="{{ route('home') }}" class="group relative px-8 py-3.5 flex items-center gap-3 overflow-hidden rounded-2xl bg-white/5 border border-white/10 dark:bg-white/5 dark:border-white/10 backdrop-blur-xl transition-all hover:border-primary-cyan/50 hover:shadow-[0_0_30px_rgba(14, 165, 233,0.15)] active:scale-95">
