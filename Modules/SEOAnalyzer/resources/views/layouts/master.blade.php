...
<body style="background-color: var(--bg-color); color: var(--text-main);">
    <canvas id="techCanvas" style="position: fixed; inset: 0; z-index: -1; opacity: 0.3; pointer-events: none;"></canvas>
    
    @include('partials.header')

    <main style="padding-top: 8rem; padding-bottom: 5rem; min-height: 100vh; padding-left: 1rem; padding-right: 1rem;">
        @yield('content')
