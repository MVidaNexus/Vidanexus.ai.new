...
/**
 * One-off server helper: replace/patch AIKeywordRadar job and controller when file
 * permissions require delete+recreate.
 * Run: php scripts/maintenance/apply_patches.php
 */
